...
ouvrir la console Group Policy Management ;
créer une nouvelle GPO ;
lui attribuer un nom explicite ;
modifier les paramètres souhaités ;
lier la GPO à l'OU concernée ;
vérifier son application sur un poste client.
Exemple de stratégie

Exemple de politique pouvant être utilisée dans un environnement de test :
